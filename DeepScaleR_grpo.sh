...
export YOUR_PROJECT_NAME="DeepScaleR-grpo"
export YOUR_RUN_NAME="DeepScaleR-grpo-$(date +%Y%m%d-%H%M%S)"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo --config-path=config \
 ...
 data.filter_overlong_prompts=True \
    ...
    actor_rollout_ref.rollout.trace.max_samples_per_step_per_worker=4 \
